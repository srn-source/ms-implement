...
from data import BaseProcessor, SST2Processor, AGNewsProcessor

from model import GPT2Wrapper, LlamaWrapper, GPT3Wrapper
...
def main(args):
    ...
    out_res = model_type.complete_all(
        prompts, prompts_cali, prompts_cali2, prompts_cali3
    )
    # print(out_res)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset", type=str, default="sst2", help="SetFit/sst2, agnews"
    )
    ...
    parser.add_argument("--perplexity_ordering_kate", default=False, action="store_true")
    ...
    parser.add_argument(
        "--kate_metric", type=str, default="euclidean", help="euclidean or cosine"
    )
    parser.add_argument(
        "--encoder_kate",
        default="roberta-base",
        type=str,
        help="roberta-base, roberta-large",
    )
